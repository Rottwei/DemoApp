...
jQuery.sap.declare("exa.common.makit.ConfigurationBuilder");

exa.common.makit.ConfigurationBuilder =  function () {
	
};

exa.common.makit.ConfigurationBuilder.generateConfigPopover = function(oChart) {
	...
	var oCategoryAxisConfigList = new sap.m.List({
		headerText: "X Axis Property",
		inset : true
	});

	var oValuesAxisConfigList = new sap.m.List({
		headerText: "Y Axis Property",
		inset : true
	});

	var oValueBubbleAxisConfigList = new sap.m.List({
		headerText: "Y Tooltip Property",
		inset : true
	});

	this.generateChartConfigList(oChartConfigList, oChart);
	this.generateCategoryAxisConfigList(oCategoryAxisConfigList, oChart);
	this.generateValuesAxisConfigList(oValuesAxisConfigList, oChart);
	this.generateValueBubbleConfigList(oValueBubbleAxisConfigList, oChart);
	...
	var oButton = new sap.m.Button({
		text: "Configure", icon: "sap-icon://settings",
		press : function() {
...
exa.common.makit.ConfigurationBuilder.generateChartConfigList = function(oList, oChart) {
	var oListItem = null;
	var oSwitch = null;
	...
	var rangeSelectorStartPosition = oChart.getRangeSelectorStartPosition();
	if(!rangeSelectorStartPosition)
	rangeSelectorStartPosition = 0;
	
	oListItem = new sap.m.InputListItem({label:"Range Selector Start Position"});
	var oInput = new sap.m.Input({
		type: sap.m.InputType.Number,
		value : rangeSelectorStartPosition,
		change : function() {
...
exa.common.makit.ConfigurationBuilder.generateCategoryAxisConfigList = function(oList, oChart) {
	var oListItem = null;
	var oSwitch = null;
...
exa.common.makit.ConfigurationBuilder.generateValuesAxisConfigList = function(oList, oChart) {
	var oListItem = null;
	var oSwitch = null;
...
exa.common.makit.ConfigurationBuilder.generateValueBubbleConfigList = function(oList, oChart) {
	var oListItem = null;
	var oSwitch = null;
